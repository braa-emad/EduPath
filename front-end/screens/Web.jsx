      ...
      <View style={styles.contentContainer}>
        ...
        {activeTab === 'About' ? (
          ...
          <View style={styles.head}>
            <Text style={styles.uxTitle}>Web Development</Text>
            <Text style={styles.uxDesc}>Unlock the world of web development with our comprehensive course designed for beginners and aspiring developers. Whether you're new to programming or looking to advance your skills, this course will guide you step-by-step in creating modern, responsive websites and web applications.</Text>
          </View>
          <View style={styles.box}>
            <View style={styles.left}>
              ...
              <View style={styles.leftCard}>
                <Text style={styles.leftText}>Development & Designing</Text>
              </View>
            </View>
            <View style={styles.right}>
              <Text style={styles.rightText}>180 Students</Text>
            </View>
          </View>
          ...
          <View style={[styles.skills, {marginBottom: 32}]}>
            ...
            <View style={styles.skillsBox}>
              <View style={{flexDirection: 'row', gap: 8, marginBottom: 12, alignItems: 'center'}}>
                ...
                <Text style={{fontWeight: '400', fontSize: 16, color: '#18223599'}}>Web Designing</Text>
              </View> 
              <View style={{flexDirection: 'row', gap: 8, marginBottom: 12, alignItems: 'center'}}>
                <Text style={{fontSize: 26}}>•</Text>
                <Text style={{fontWeight: '400', fontSize: 16, color: '#18223599'}}>Development</Text>
              </View>
              <View style={{flexDirection: 'row', gap: 8, marginBottom: 12, alignItems: 'center' }}>
                <Text style={{fontSize: 26}}>•</Text>
                <Text style={{fontWeight: '400', fontSize: 16, color: '#18223599'}}>Structuring</Text>
              </View>
              <View style={{flexDirection: 'row', gap: 8, marginBottom: 12, alignItems: 'center' }}>
                <Text style={{fontSize: 26}}>•</Text>
                <Text style={{fontWeight: '400', fontSize: 16, color: '#18223599'}}>React JS</Text>
              </View>
              <View style={{flexDirection: 'row', gap: 8, marginBottom: 12, alignItems: 'center'}}>
                <Text style={{fontSize: 26}}>•</Text>
                <Text style={{fontWeight: '400', fontSize: 16, color: '#18223599'}}>Next JS</Text>
              </View>
            </View>
          </View>
        </View>
